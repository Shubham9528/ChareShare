...
import { OnboardingFlow } from './components/patientprofile/onboarding/OnboardingFlow';
import { LoginSelectionPage } from './components/loginSelection/LoginSelectionPage';
import { AuthPage } from './components/auth/AuthPage';
import { Dashboard } from './components/Dashboard';
import { CategoryPage } from './components/patientprofile/category/CategoryPage';
import { ProfilePage } from './components/patientprofile/profile/ProfilePage';
import { BookingPage } from './components/patientprofile/booking/BookingPage';
import { MessagingPage } from './components/patientprofile/messaging/MessagingPage';
import { SearchPage } from './components/patientprofile/search/SearchPage';
import { ProviderSearchPage } from './components/providerprofile/search/SearchPage';
import { ProviderServicePage } from './components/patientprofile/providerservice/ProviderServicePage';
...
import { SettingsPage } from './components/patientprofile/settings/SettingsPage';
import { EditProfilePage as PatientEditProfilePage } from './components/patientprofile/settings/EditProfilePage';
import { UploadDocumentPage, CameraScanPage } from './components/patientprofile/settings/uploaddocument';
import { FavoritesPage } from './components/patientprofile/settings/favorites';
import { InsuranceBenefitsPage } from './components/patientprofile/settings/insurance';
import { AppointmentBookingPage } from './components/patientprofile/providerservice/appointment/AppointmentBookingPage';
import { PackageSelectionPage } from './components/patientprofile/providerservice/package/PackageSelectionPage';
import { ConfirmDetailsPage } from './components/patientprofile/providerservice/confirmdetails/ConfirmDetailsPage';
import { PrivacyPolicyPage } from './components/patientprofile/settings/policy';
